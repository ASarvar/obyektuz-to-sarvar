      ...
      <div className="top1">
        ...
        <Navbar className="topphone">
          ...
          <div className="email">
            ...
            <a href="mailto:sb@mail.uz">info@obyekt.uz</a>
          </div>
        </Navbar>
      </div>
      <div>
        <Navbar
          className={props.position + " main-nav sticky-nav"}
          id="navbar"
          expand="lg"
        >
          <div class="line"></div>
          <Container>
            ...
            <div
              ...
              onClick={() =>
                setActiveToggle(activeToggle === "" ? "activeClass" : "")
              }
            ></div>
            <Navbar.Collapse id="basic-navbar-nav" className={activeToggle}>
              ...
              {t("Menu.news")}
                ...
                {t("Menu.data.vacancy")}
                  ...
                  <NavDropdown
                    title={t("Menu.antikorrupsiya.menu")}
                    className="navLinkDropdown hover"
                    // id="basic-nav-dropdown"
                  >
                    <NavDropdown.Item
